...
const Goal = (props: GoalProps) => {
  const stepThree = props?.onChange("Three");
  const [disabled, setDisabled] = useState(true);

  const objectiveChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const objective = event.target.value;
    stepThree("objective", objective);
  };

  useEffect(() => {
    if (props?.data?.stepThree?.objective) setDisabled(false);
  }, [props?.data?.stepThree]);
          ...
          >
            <div className="block">
              ...
              <div className="w-full">
                I want to hit more performance numbers
              </div>
            </div>
          </label>
        </li>
        <li>
          ...
          >
            <div className="block">
              ...
              <div className="w-full">
                I like my current body and maintain it
              </div>
            </div>
          </label>
        </li>
